#
#  Be sure to run `pod spec lint RAMReel.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Mikhail Stepkin"
  # s.authors            = { "Mikhail Stepkin" => "mikhail.s@ramotion.com" }
  # s.social_media_url   = "http://twitter.com/Mikhail Stepkin"
  ...
  s.source       = { :git => "https://github.com/Ramotion/reel-search", :tag => "0.0.1" }
